...
>
    <div class="mt-3 md:mt-0 relative">
     ...
     type="text" class=" bg-gray-700 rounded-full ml-8 w-60 px-4 py-1 focus:outline-none focus:ring-1 " 
     ...
     <div class="md:ml-4 mt-3 md:mt-0">
             <a href="{{url('creator')}}">
                 <img src="/img/avatar.jpg" alt="creator" class="w-8 h-8 rounded-full">
             </a>
     </div>
