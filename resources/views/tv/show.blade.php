...
@section('content')
  <section class="tvShow-info border-b border-gray-600">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <img src="{{'https://image.tmdb.org/t/p/w500/' .$tvShow['poster_path']}} " alt="poster_path" class=" md:w-96 w-64">

        <div class="md:ml-24">
            <h2 class=" text-4xl font-semibold">
                {{$tvShow['name']}} ({{ \Carbon\Carbon::parse($tvShow['first_air_date'])->format('Y') }})
            </h2>
                        ...
                        <div class=" bg-gray-900 rounded">
                            ...
                            <div class="modal-body px-8 py-8">
                                <div class=" responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/{{$tvShow['videos']['results'][0]['key']}}" frameborder="0" class="responsive-iframe absolute w-full h-full left-0 top-0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
